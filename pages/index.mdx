...
# Building a Secure Connection for Hybrid Apps
...
<button><a href="https://github.com/victoriaplummer/Hybrid-App-Authentication-w.-ID-tokens">Download Full App</a></button>
...
## Set you your development environment

### Clone the starter code

We've pre-configured a Designer Extension and Data Client using our templates designed to give you a solid foundation. In this tutorial, you will be guided through adding specific code examples. If you are curious about the final app or need a reference, you can download the complete App here. 

<button><a href="https://github.com/victoriaplummer/Hybrid-App-Authentication-w.-ID-tokens">Download Starter Code</a></button>
...
```javascript jwt.js focus=4:8 mark=4:8
...
#### [TBD](https://stripe.com/docs/payments/checkout/fulfill-orders)

tktk

#### [TBD](https://stripe.com/docs/payouts)

tktk

#### [TBD](https://stripe.com/docs/refunds)
