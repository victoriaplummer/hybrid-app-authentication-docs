...
We've pre-configured a Designer Extension and Data Client designed to give you a solid foundation. In this tutorial, you will be guided through adding specific code examples. If you are curious about the final app or need a reference, you can download the complete App here. 

<button><a href="https://github.com/victoriaplummer/Hybrid-App-Authentication-w.-ID-tokens" target="_blank">Download Starter Code</a></button>
